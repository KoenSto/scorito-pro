...
De renner- en puntendata komen uit \`Scorito_Tour_2026_Poule_184renners.xlsx\`. De etappeprofielen
(vlak/heuvel/berg) zijn een inschatting en kunnen later worden verfijnd.

## Deploy

Automatische deploy naar GitHub Pages via GitHub Actions (.github/workflows/deploy.yml).
Zet hiervoor in Settings > Pages de bron op "GitHub Actions".
